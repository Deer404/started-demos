...
// node_modules/.pnpm/hono@4.5.2/node_modules/hono/dist/utils/html.js
...
var SwaggerUI = (options) => {
  ...
  return `
    <div>
      ...
      ${asset.css.map((url) => html2`<link rel="stylesheet" href="${url}" />`)}
      ${asset.js.map((url) => html2`<script src="${url}" crossorigin="anonymous"></script>`)}
      <script>
        window.onload = () => {
...
var enhanceMissingParametersError = function(action, paramsToAdd) {
  try {
    return action();
  } catch (error) {
...
// node_modules/.pnpm/hono@4.5.2/node_modules/hono/dist/utils/cookie.js
...
// node_modules/.pnpm/hono@4.5.2/node_modules/hono/dist/helper/cookie/index.js
...
// node_modules/.pnpm/hono@4.5.2/node_modules/hono/dist/http-exception.js
...
// node_modules/.pnpm/hono@4.5.2/node_modules/hono/dist/utils/buffer.js
...
// node_modules/.pnpm/hono@4.5.2/node_modules/hono/dist/validator/validator.js
...
// node_modules/.pnpm/hono@4.5.2/node_modules/hono/dist/utils/body.js
...
// node_modules/.pnpm/hono@4.5.2/node_modules/hono/dist/request.js
...
// node_modules/.pnpm/hono@4.5.2/node_modules/hono/dist/context.js
...
// node_modules/.pnpm/hono@4.5.2/node_modules/hono/dist/compose.js
...
// node_modules/.pnpm/hono@4.5.2/node_modules/hono/dist/router.js
...
// node_modules/.pnpm/hono@4.5.2/node_modules/hono/dist/hono-base.js
...
// node_modules/.pnpm/hono@4.5.2/node_modules/hono/dist/router/reg-exp-router/node.js
...
// node_modules/.pnpm/hono@4.5.2/node_modules/hono/dist/router/reg-exp-router/trie.js
var Trie = class {
  context = { varIndex: 0 };
  root = new Node;
...
// node_modules/.pnpm/hono@4.5.2/node_modules/hono/dist/router/reg-exp-router/router.js
...
var findMiddleware = function(middleware2, path) {
  if (!middleware2) {
    return;
  }
...
// node_modules/.pnpm/hono@4.5.2/node_modules/hono/dist/router/smart-router/router.js
...
// node_modules/.pnpm/hono@4.5.2/node_modules/hono/dist/router/trie-router/node.js
var Node2 = class {
  methods;
  children;
  patterns;
...
// node_modules/.pnpm/hono@4.5.2/node_modules/hono/dist/router/trie-router/router.js
...
// node_modules/.pnpm/hono@4.5.2/node_modules/hono/dist/hono.js
...
var OpenAPIHono = class _OpenAPIHono extends Hono2 {
  ...
  openapi = ({ middleware: routeMiddleware, ...route }, handler, hook = this.defaultHook) => {
    ...
    if (route.request?.query) {
      const validator4 = zValidator("query", route.request.query, hook);
      validators.push(validator4);
    }
    if (route.request?.params) {
      const validator4 = zValidator("param", route.request.params, hook);
      validators.push(validator4);
    }
    if (route.request?.headers) {
      const validator4 = zValidator("header", route.request.headers, hook);
      validators.push(validator4);
    }
    if (route.request?.cookies) {
      const validator4 = zValidator("cookie", route.request.cookies, hook);
      validators.push(validator4);
    }
...
var postMessageRoute = createRoute({
  method: "post",
  path: "/api/message",
  request: {
    body: {
